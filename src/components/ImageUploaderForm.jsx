...
// make it a form element with class name ImageUploaderForm ok
// write one input element and button element inside ok
...
export default class ImageUploaderForm extends React.Component {
  ...
  render() {
    ...
    return (
      <form onSubmit={e => handleSubmit(e)} className="ImageUploaderForm">
        <input
          type="text"
